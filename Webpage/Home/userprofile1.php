        ...
        <div class="wrapper-statistics">
          <div class="panel">
            ...
            <div class="panel-body">
              ...
              <div class="chart">
                <div class="radiation">
                  <span class="EMF-radiation">
                    <span></span>EMF
                  </span>
                  <span class="radioactive-radiation">
                    <span></span>Radioactive
                  </span>
                  <span class="other-radiation">
                    <span></span>Other
                  </span>
                </div>

                <div class="radioactive-stats">
                  1.24<span></span>
                </div>
                <div class="EMF-stats">
                  <span></span>1.42
      ...
      <section>
        <div style="padding-top: 5rem;" id="transportation" class="container">
          <div class="row align-items-center">
            <div class="col-lg-6">
              <div class="p-5">
                <ul class="list-unstyled">
                  <li class="media">
                    <img class="img-fluid mr-3" src="images/covid.jpg" alt="Generic placeholder image">
                    <div style="padding-top: 4rem; padding-left: 2rem;" class="media-body">
                      <h5 class="mt-0 mb-1"><a href="index.html">Covid-19</a></h5>
                      Since it's forbidden by some countrys to leave you home for more than 1h, it doesn't mean that EMF radiation cannot harm you anymore.The radiation inside your own four walls is most of the time more harmfull than the one outside. Find additional information <a href="index.html">here</a>!
                  </li>
                  <li class="media">
                    <img class="img-fluid mr-3" src="images/shutdown.jpg" alt="Generic placeholder image">
                    <div style="padding-top: 4rem; padding-left: 2rem;" class="media-body">
                      <h5 class="mt-0 mb-1"><a href="index.html">Shutdown</a></h5>
                      Due to maintenance work the website is temporarily unavailable from 22.4.2020 to 8.9.2030
                    </div>
                  </li>
                  <li class="media">
                    <img class="img-fluid mr-3" src="images/arduino_uno.jpg" alt="Generic placeholder image">
                    <div style="padding-top: 4rem; padding-left: 2rem;" class="media-body">
                      <h5 class="mt-0 mb-1"><a href="index.html">Product</a></h5>
                      See the first prototype <a href="index.html"> here! </a>
                    </div>
                  </li>
                </ul>
              </div>
            ...
            <div class="col-lg-6">
              <div class="p-3">
                <h2 class="display-3">Latest News</h2>
                <p></p>
              </div>
            </div>
          </div>
      ...
      <section>
        <div style="padding-top: 5rem;padding-bottom: 5rem;" id="gallery" class="container">
          <div class="row align-items-center">
            <div class="col-lg-12">
              <div class="p-5">
                <h2 class="display-3">Photo upload</h2>
                <h2>Your Gallery</h2>
                <br>
